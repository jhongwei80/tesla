 ...
 */
package io.github.tesla.gateway.config.eureka.metadata;
...
/**
 * @author liushiming
 * @version DefaultManagementMetadataProvider.java, v 0.0.1 2018年5月4日 下午6:40:24 liushiming
 */
public class DefaultManagementMetadataProvider {

    private static final int RANDOM_PORT = 0;
    private static final Log log = LogFactory.getLog(DefaultManagementMetadataProvider.class);

    private static String constructValidUrl(String scheme, String hostname, int port, String contextPath,
        String statusPath) {
        try {
    ...
    private static String getErrorMessage(String scheme, String hostname, int port, String contextPath,
        String statusPath) {
    ...
    public static String getGreyUrl(EurekaInstanceConfigBean instance, int serverPort, String serverContextPath,
        String managementContextPath, Integer managementPort, boolean isSecure) {
        String greyApiUrl =
            getUrl(instance, serverPort, serverContextPath, "", managementPort, managementContextPath, isSecure);
        return greyApiUrl;
    }

    private static String getUrl(EurekaInstanceConfigBean instance, int serverPort, String serverContextPath,
    ...
    private static String refineManagementContextPath(String serverContextPath, String managementContextPath,
    ...
    public ManagementMetadata get(EurekaInstanceConfigBean instance, int serverPort, String serverContextPath,
        ...
        String healthCheckUrl =
            getHealthCheckUrl(instance, serverPort, serverContextPath, managementContextPath, managementPort, false);
        String statusPageUrl =
            getStatusPageUrl(instance, serverPort, serverContextPath, managementContextPath, managementPort);

        ManagementMetadata metadata =
            new ManagementMetadata(healthCheckUrl, statusPageUrl, managementPort == null ? serverPort : managementPort);
