...
/**
 * @author liushiming
 * @version InstanceInfoFactory.java, v 0.0.1 2018年5月6日 上午10:27:12 liushiming
 */
public class InstanceInfoFactory {
    ...
    public InstanceInfo create(EurekaInstanceConfig config) {
        ...
        builder.setNamespace(namespace).setAppName(config.getAppname()).setInstanceId(config.getInstanceId())
            ...
            .setIPAddr(config.getIpAddress()).setHostName(config.getHostName(false)).setPort(config.getNonSecurePort())
