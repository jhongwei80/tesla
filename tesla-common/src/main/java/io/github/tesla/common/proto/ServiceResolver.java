...
public class ServiceResolver {
     ...
     */
    private static ImmutableMap<String, FileDescriptorProto>
        computeDescriptorProtoIndex(FileDescriptorSet fileDescriptorSet) {
    ...
    /**
     * Recursively constructs file descriptors for all dependencies of the supplied proto and returns a
     * {@link FileDescriptor} for the supplied proto itself. For maximal efficiency, reuse the descriptorCache argument
     * across calls.
     */
    private static FileDescriptor descriptorFromProto(FileDescriptorProto descriptorProto,
        ImmutableMap<String, FileDescriptorProto> descriptorProtoIndex, Map<String, FileDescriptor> descriptorCache)
    ...
    /**
     * Returns the descriptor of a protobuf method with the supplied grpc method name. If the method cannot be found,
     * this throws {@link IllegalArgumentException}.
     */

    public MethodDescriptor resolveServiceMethod(String serviceName, String methodName, String packageName) {
