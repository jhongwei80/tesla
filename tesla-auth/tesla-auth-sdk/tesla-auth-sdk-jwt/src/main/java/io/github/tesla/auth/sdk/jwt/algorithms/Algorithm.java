...
import io.github.tesla.auth.sdk.jwt.interfaces.ECDSAKeyProvider;
import io.github.tesla.auth.sdk.jwt.interfaces.RSAKeyProvider;
...
public abstract class Algorithm {
     ...
     *
     * @param keyProvider
     *            the provider of the Public Key and Private Key for the verify and signing instance.
     ...
     *
     * @param publicKey
     *            the key to use in the verify instance.
     * @param privateKey
     *            the key to use in the signing instance.
     * @return a valid RSA256 Algorithm.
     * @throws IllegalArgumentException
     ...
     *
     * @param key
     *            the key to use in the verify or signing instance.
     * @return a valid RSA256 Algorithm.
     * @throws IllegalArgumentException
     ...
     *
     * @param secret
     *            the secret bytes to use in the verify or signing instance.
     * @return a valid HMAC256 Algorithm.
     * @throws IllegalArgumentException
     *             if the provided Secret is null.
     */
    ...
    /**
     * Getter for the Id of the Private Key used to sign the tokens. This is usually specified as the `kid` claim in the
     * Header.
     *
    ...
    /**
     * Getter for the description of this Algorithm, required when instantiating a Mac or Signature object. i.e.
     * "HmacSHA256"
     *
     ...
     *
     * @param jwt
     *            the already decoded JWT that it's going to be verified.
     * @throws SignatureVerificationException
     *             if the Token's Signature is invalid, meaning that it doesn't match the signatureBytes, or if the Key
     *             is invalid.
     */
     ...
     *
     * @param contentBytes
     *            an array of bytes representing the base64 encoded content to be verified against the signature.
