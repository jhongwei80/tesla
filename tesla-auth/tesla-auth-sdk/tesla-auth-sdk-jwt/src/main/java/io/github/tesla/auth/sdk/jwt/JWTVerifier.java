...
import io.github.tesla.auth.sdk.jwt.exceptions.*;
import io.github.tesla.auth.sdk.jwt.impl.PublicClaims;
...
/**
 * The JWTVerifier class holds the verify method to assert that a given Token has not only a proper JWT format, but also
 * it's signature matches.
 */
...
public final class JWTVerifier {
    ...
    public static class BaseVerification implements Verification {
        ...
        /**
         * Define the default window in seconds in which the Not Before, Issued At and Expires At Claims will still be
         * valid. Setting a specific leeway value on a given Claim will override this value for that Claim.
         *
         * @param leeway
         *            the window in seconds in which the Not Before, Issued At and Expires At Claims will still be
         *            valid.
         * @return this same Verification instance.
         * @throws IllegalArgumentException
        ...
        /**
         * Set a specific leeway window in seconds in which the Expires At ("exp") Claim will still be valid. Expiration
         * Date is always verified when the value is present. This method overrides the value set with acceptLeeway
         *
         * @param leeway
         *            the window in seconds in which the Expires At Claim will still be valid.
         * @return this same Verification instance.
         * @throws IllegalArgumentException
         *             if leeway is negative.
         */
        ...
        /**
         * Set a specific leeway window in seconds in which the Not Before ("nbf") Claim will still be valid. Not Before
         * Date is always verified when the value is present. This method overrides the value set with acceptLeeway
         *
         * @param leeway
         *            the window in seconds in which the Not Before Claim will still be valid.
         * @return this same Verification instance.
         * @throws IllegalArgumentException
         *             if leeway is negative.
         */
        ...
        /**
         * Set a specific leeway window in seconds in which the Issued At ("iat") Claim will still be valid. Issued At
         * Date is always verified when the value is present. This method overrides the value set with acceptLeeway
         *
         * @param leeway
         *            the window in seconds in which the Issued At Claim will still be valid.
         * @return this same Verification instance.
         * @throws IllegalArgumentException
         *             if leeway is negative.
         */
        ...
        /**
         * Creates a new and reusable instance of the JWTVerifier with the configuration already provided. ONLY FOR TEST
         * PURPOSES.
         *
         * @param clock
     ...
     *             if the algorithm stated in the token's header it's not equal to the one defined in the
     *             {@link JWTVerifier}.
