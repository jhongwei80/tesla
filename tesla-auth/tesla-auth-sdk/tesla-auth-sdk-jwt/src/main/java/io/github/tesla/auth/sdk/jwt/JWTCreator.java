...
import io.github.tesla.auth.sdk.jwt.exceptions.JWTCreationException;
import io.github.tesla.auth.sdk.jwt.exceptions.SignatureGenerationException;
import io.github.tesla.auth.sdk.jwt.impl.ClaimsHolder;
import io.github.tesla.auth.sdk.jwt.impl.PayloadSerializer;
import io.github.tesla.auth.sdk.jwt.impl.PublicClaims;

/**
 * The JWTCreator class holds the sign method to generate a complete JWT (with Signature) from a given Header and
 * Payload content.
 */
...
public final class JWTCreator {
    ...
    public static class Builder {
        ...
        /**
         * Add a specific Key Id ("kid") claim to the Header. If the {@link Algorithm} used to sign this token was
         * instantiated with a KeyProvider, the 'kid' value will be taken from that provider and this one will be
         * ignored.
         *
         * @param keyId
         *            the Key Id value.
