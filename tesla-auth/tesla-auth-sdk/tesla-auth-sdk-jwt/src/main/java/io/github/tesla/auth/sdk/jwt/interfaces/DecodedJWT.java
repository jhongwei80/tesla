...
public interface DecodedJWT extends Payload, Header {
    ...
    /**
     * Getter for the Header contained in the JWT as a Base64 encoded String. This represents the first part of the
     * token.
     *
    ...
    /**
     * Getter for the Payload contained in the JWT as a Base64 encoded String. This represents the second part of the
     * token.
     *
    ...
    /**
     * Getter for the Signature contained in the JWT as a Base64 encoded String. This represents the third part of the
     * token.
     *
