 ...
 */
package io.github.tesla.auth.sdk.signer.encoding;
 ...
 * <p>
 * AWS expects most strings incorporated into the string to sign to be URL-encoded, and unfortunately the exact
 * requirements aren't exactly standard:
 * <ul>
 * <li>It requires to encode '~", so {@code URLEncodedUtils} and {@code URIBuilder} from Apache HTTP Client won't work.
 * <li>It requires to encode spaces as '%20', not '+', so {@link java.net.URLEncoder} won't work.
 * </ul>
 *
