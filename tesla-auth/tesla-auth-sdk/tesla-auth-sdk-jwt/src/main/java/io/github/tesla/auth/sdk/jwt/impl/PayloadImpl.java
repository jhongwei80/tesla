...
class PayloadImpl implements Payload {
    ...
    PayloadImpl(String issuer, String subject, List<String> audience, Date expiresAt, Date notBefore, Date issuedAt,
    ...
    public Map<String, Claim> getClaims() {
        ...
        for (String name : tree.keySet()) {
            claims.put(name, JsonNodeClaim.extractClaim(name, tree));
        }
