...
public interface Claim {
    ...
    /**
     * Get this Claim as a Boolean. If the value isn't of type Boolean or it can't be converted to a Boolean, null will
     * be returned.
     *
    ...
    /**
     * Get this Claim as an Integer. If the value isn't of type Integer or it can't be converted to an Integer, null
     * will be returned.
     *
    ...
    /**
     * Get this Claim as an Long. If the value isn't of type Long or it can't be converted to an Long, null will be
     * returned.
     *
    ...
    /**
     * Get this Claim as a Double. If the value isn't of type Double or it can't be converted to a Double, null will be
     * returned.
     *
    ...
    /**
     * Get this Claim as a String. If the value isn't of type String or it can't be converted to a String, null will be
     * returned.
     *
