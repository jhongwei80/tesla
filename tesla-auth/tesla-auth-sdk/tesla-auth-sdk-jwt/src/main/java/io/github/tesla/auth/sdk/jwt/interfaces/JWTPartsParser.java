...
/**
 * The JWTPartsParser class defines which parts of the JWT should be converted to it's specific Object representation
 * instance.
 */
public interface JWTPartsParser {
     ...
     *
     * @param json
     *            the content of the Payload in a JSON representation.
     * @return the Payload.
     ...
     *
     * @param json
     *            the content of the Header in a JSON representation.
     * @return the Header.
     * @throws JWTDecodeException
     *             if the json doesn't have a proper JSON format.
     */
