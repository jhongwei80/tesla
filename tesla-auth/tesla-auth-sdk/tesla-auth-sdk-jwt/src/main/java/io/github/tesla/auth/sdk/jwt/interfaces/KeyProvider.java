 ...
 *
 * @param <U>
 *            the class that represents the Public Key
 * @param <R>
 *            the class that represents the Private Key
 */
interface KeyProvider<U extends PublicKey, R extends PrivateKey> {
     ...
     *
     * @param keyId
     *            the Key Id specified in the Token's Header or null if none is available. Provides a hint on which
     *            Public Key to use to verify the token's signature.
    ...
    /**
     * Getter for the Id of the Private Key used to sign the tokens. This represents the `kid` claim and will be placed
     * in the Header.
     *
