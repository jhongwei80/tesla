...
import io.github.tesla.auth.server.oauth.authorize.CodeAuthorizeHandler;
import io.github.tesla.auth.server.oauth.authorize.TokenAuthorizeHandler;
import io.github.tesla.auth.server.oauth.support.OAuthAuthxRequest;
...
public class OauthAuthorizeController {
    ...
    /**
     * Must handle the grant_type as follow: grant_type="authorization_code" -> response_type="code"
